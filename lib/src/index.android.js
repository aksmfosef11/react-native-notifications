...
export class NotificationsAndroid {
  ...
  static changeAlarmSetting(alarmType,isAlarm){
    RNNotifications.changeAlarmSetting(alarmType,isAlarm);
  }

  static setTalkUID(talkUID){
    RNNotifications.setTalkUID(talkUID);
  }

  static setGroupTalkUID(groupTalkUID){
    RNNotifications.setGroupTalkUID(groupTalkUID);
  }

  static setRadioUID(radioUID){
    RNNotifications.setRadioUID(radioUID);
  }

  static setIsFocusRadio(isFocus){
    RNNotifications.setIsFocusRadio(isFocus);;
  }
